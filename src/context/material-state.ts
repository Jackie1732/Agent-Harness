...
export function projectMaterials(index: SourceIndex): ContextMaterialState {
  ...
  for (const event of local.events) {
    ...
    if (definition === contextProfileRecordedEvent || definition === agentContextProfileRecordedEvent || definition === subagentContextProfileRecordedEvent) {
    ...
    } else if (definition === contextAssemblyCommittedEvent || definition === agentContextAssemblyCommittedEvent || definition === subagentContextAssemblyCommittedEvent) {
