...
export type AgentNativeActionName = typeof agentNativeActionNames[number]
export type AgentActionReference = { readonly eventId: SessionEventId; readonly index: number }
export type AgentInputReference = { readonly kind: 'user' | 'peer'; readonly eventId: SessionEventId }
