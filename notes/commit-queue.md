...
| C-0017 | Codex | `step2` | `1aab5e8` | `committed-local` | 审查 CL-0016 并修正两处文档错误：`require()` 的 committed view 误称改回 attempt view；CapabilityKey 示例改用工厂函数 | 待执行：逐项门禁 | 同时把 D-0012/C-0013/D-0014/C-0015 四行同步为 step0 上的 landed 版本，消除 step2 与基线的队列漂移 |
## 工作规则
